...
const (
	baseURL        = "https://api.apiverve.com/v1/ovulationcalculator"
	defaultTimeout = 30 * time.Second
)

// Client is the Ovulation Calculator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Ovulation Calculator API client.
...
// Execute makes a request to the Ovulation Calculator API with typed parameters.
//
