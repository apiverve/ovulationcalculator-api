...
class ovulationcalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/ovulationcalculator');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/ovulationcalculator';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"last_period":{"type":"string","required":true,"format":"date"},"cycle_length":{"type":"integer","required":false,"min":21,"max":35,"default":28}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/ovulationcalculator`);
        }
    }
...
module.exports = ovulationcalculatorWrapper;
