...
namespace APIVerve.API.OvulationCalculator
{
    ...
    /// <summary>
    /// Client for the OvulationCalculator API
    /// </summary>
    public class OvulationCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/ovulationcalculator";
        ...
        public OvulationCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public OvulationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public OvulationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, OvulationCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(OvulationCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(OvulationCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(OvulationCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(OvulationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(OvulationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(OvulationCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(OvulationCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(OvulationCalculatorQueryOptions options)
        {
