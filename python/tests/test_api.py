...
class TestOvulationcalculatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = OvulationcalculatorAPIClient(self.api_key)

    @patch('apiverve_ovulationcalculator.apiClient.requests.get')
