# Ovulation Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:ovulationcalculator-api:1.1.12'
}
```
...
```java
import com.apiverve.ovulationcalculator.OvulationCalculatorAPIClient;
import com.apiverve.ovulationcalculator.APIResponse;
import com.apiverve.ovulationcalculator.APIException;

// Initialize the client
OvulationCalculatorAPIClient client = new OvulationCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ovulationcalculator](https://docs.apiverve.com/ref/ovulationcalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/ovulationcalculator](https://docs.apiverve.com/ref/ovulationcalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ovulationcalculator-api/issues)
